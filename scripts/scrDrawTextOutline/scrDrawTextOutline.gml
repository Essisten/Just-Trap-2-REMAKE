/// @description scrDrawTextOutline(x, y, string, text_color, outline_color, [outline_width=1], [detail=8])
/// @param x
/// @param  y
/// @param  string
/// @param  text_color
/// @param  outline_color
/// @param  [outline_width=1]
/// @param  [detail=8]
function scrDrawTextOutline() {
	...
	draw_text(xx, yy, string_hash_to_newline(_text));
